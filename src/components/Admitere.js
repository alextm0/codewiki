    ...
    <div className='max-w-[1024px] mx-auto'>
      <div className='max-w-[1024px] mx-auto'>
        <Category categoryName={"Algoritmi elementari"} categoryDescription={"Clasa IX"} topics={[
          ...
          {
            name: "Divizibilitate",
            description: "Determinarea numarului de divizori. Descompunerea in factori primi. Algoritmul lui Euclid",
            stars: 5
          },
          {
            name: "Numere prime & Ciurul lui Eratostene",
            description: "Intelegerea ciurului lui Eratostene, verificarea primalitatii si probleme care deriva din acest algoritm",
            stars: 4
          },
          {
          ...
          },
          {
            ...
            description: "Transformarea unui numar din baza 10 in baza 2. Lucrul in baza 2",
            stars: 2
          }
        ]} />
