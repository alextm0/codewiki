          ...
          <div className='md:hidden relative'>
            ...
            <div id="hs-offcanvas-example" className={`${sidebar} hs-offcanvas hs-offcanvas-open:translate-x-0 -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full max-w-xs  z-[60] bg-white border-r ${sidebar ? 'shadow-sm' : ''} shadow-white border-r-gray-500 dark:bg-gray-800 dark:border-gray-700" tabindex="-1`}>
              <div class="flex flex-col w-64 h-screen px-4 py-8 bg-gray-800 border-gray-600">
                {/* Logo */}
                <Link to={'/'}>
                  <h2 class="text-3xl text-gray-800 dark:text-white inline-flex items-center gap-2 mb-5 font-righteous "> <img src={Logo} alt="logo" /> CodeWiki</h2>
                </Link>
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                  <nav>
                    <a class="flex items-center px-4 py-2  rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <a class="dropdown dropdown-down flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>

                      <div className="mx-2 border-transparent">
                        <button className='p-2 flex items-center gap-2'> Categorii <IoMdArrowDropdown /> </button>
                  ...
                  <div class="flex flex-col  px-4 -mx-2">
                    ...
                    <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                      ...
                      <span class="mx-4 font-medium">Log in</span>
                    </a>
