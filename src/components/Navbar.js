        ...
        <div className="relative flex items-center justify-between space-x-4 lg:space-x-10 ">
              ...
              <div ref={dropdownRef} class="relative inline-block">
                ...
                <div class="relative after:absolute after:bg-gray-200 after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300">
                  <button
                    ...
                    class="inline-flex gap-1 items-center relative z-10 p-2 focus:outline-none hover:text-white"
                  >
          ...
          <div className="md:hidden relative">
            <button
              ...
              className="hs-dropdown-toggle py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold  text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
              data-hs-offcanvas="#hs-offcanvas-example"
            >
            ...
            <div
              ...
              className={`${sidebar} hs-offcanvas hs-offcanvas-open:translate-x-0 -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full max-w-xs  z-[60] bg-white border-r ${
                sidebar ? "shadow-sm" : ""
              } shadow-white border-r-gray-500 dark:bg-gray-800 dark:border-gray-700" tabindex="-1`}
            >
              <div class="flex flex-col w-64 h-screen px-4 py-8 bg-gray-800 border-gray-600">
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                  <nav>
                    <a
                      class="flex items-center px-4 py-2  rounded-md text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
                      href="#"
                    >
                      <svg
                        class="w-5 h-5"
                    ...
                    <a
                      class="flex items-center px-4 py-2 mt-5 text-gray-400 transition-colors duration-200 transform rounded-md hover:bg-gray-200 hover:text-gray-700"
                      href="#"
                    >
                      <svg
                        class="w-5 h-5 text-gray-400"
                    ...
                    <a
                      class="dropdown dropdown-down flex items-center px-4 py-2 mt-3 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
                      href="#"
                    >
                      <svg
                        class="w-5 h-5 text-gray-400"
                      ...
                      <div className="mx-2 border-transparent">
                        <button className="p-2 flex items-center gap-2 text-gray-400 hover:text-gray-700 font-medium">
                          {" "}
                          Categorii <IoMdArrowDropdown />{" "}
                        </button>
                        <ul
                          tabindex="0"
                          className="dropdown-content mt-2 menu p-2 shadow bg-gray-200 rounded-box w-52"
                        >
                  ...
                  <div class="flex flex-col  px-4 -mx-2">
                    ...
                    >
                      ...
                      <span class="mx-4 text-gray-400 font-medium">
                        Sign in
                      </span>
                    </a>
